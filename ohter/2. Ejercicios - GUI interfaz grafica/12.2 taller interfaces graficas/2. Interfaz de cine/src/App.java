...
public class App extends JFrame implements ActionListener {
    ...
    String[] Peliculas = { "Taxi driver", "Bophal a prayer for the rain", "La chinoise", "La estrategia del caracol",
            "Golpe de estadio" };
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch (combo2.getSelectedIndex()) {
            case 0:
                final_price = Integer.parseInt(campo1.getText()) * 12000;
                break;
            case 1:
                final_price = Integer.parseInt(campo1.getText()) * 24000;
                break;
            case 2:
                final_price = Integer.parseInt(campo1.getText()) * 37600;
                break;
        }
        JOptionPane.showMessageDialog(contenedor,
                "Gracias " + campo2.getText() + ", su valor a pagar es de: " + final_price);
