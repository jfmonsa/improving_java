...
public class Window extends JFrame implements ActionListener{
    ...
    Window(){
        ...
        cedula_txtf.setPreferredSize(new Dimension((int)Math.floor(ancho_ventana*0.5),25)); //Le damos ancho y alto en lugar de solo darle el número de columnas
        ...
        nombre_txtf.setPreferredSize(new Dimension((int)Math.floor(ancho_ventana*0.5),25)); //Le damos ancho y alto en lugar de solo darle el número de columnas
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==continuar_btn && nombre_txtf.getText()!="" && cedula_txtf.getText()!=""){
            ...
            if(rbtn1.isSelected()){
                ...
                if(e.getSource()==panel_docentes_agregar_btn){
                    Docente docente = new Docente(nombre_txtf.getText(), cedula_txtf.getText(), null, ancho_ventana, null);
        ...
        //Cuando no ingresa nombre o cedula
            ...
            JOptionPane.showMessageDialog(panel_ppal, "No ingreso cedula o nombre del empleado", "Error", JOptionPane.WARNING_MESSAGE);
        }
    }
