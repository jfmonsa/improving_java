...
public class App {
    ...
    public void menu(){
        ...
        do{
            ...
            opc = sc.nextInt();
            switch (opc) {
                case 1: setMatrixSize(); break;
                case 2: setMatrixElements(); break;
                case 3: printMatrix(); break;
                case 4: setMatrixRandomElements(); break;
                case 5: searchElementInMatrix(); break;
                case 6: frecuency(); break;
                case 7: iterateARow(); break;
                case 8: iterateAColumn(); break;
                case 0: break;
