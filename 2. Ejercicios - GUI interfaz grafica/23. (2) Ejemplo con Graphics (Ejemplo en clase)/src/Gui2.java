...
boolean pintarLinea = true;
    ...
    public Gui2(){
        ...
        addMouseListener(this); //this se refiere a la clase actual, al JFrame sobre el cual estamos extendiendo
    ...
    public void paint(Graphics g){ //el método debe escribirse tal cual
        ...
        //Este método solos sirve para crear una interfaz por primera vez atees de que el usuario interactue con ella
        ...
        g.setColor(Color.blue); //Todo lo que se pinte de aquí hasta que se declare otro setColor va a ser blue
